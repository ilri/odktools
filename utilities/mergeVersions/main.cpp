...
int main(int argc, char *argv[])
{
    ...
    title = title + " *   FNF: Field in A not found in B. It will be added to C.             * ";
    title = title + " *   VNF: Lookup value in A not found in B. It will be added to C.      * ";
    title = title + " *   FIC: The field size in A is bigger than in B. It will be increased * ";
    title = title + " *        in C to match the size of in A.                               * ";
    title = title + " *   FDC: The field in A is smaller than in B. This is a decremental    * ";
    ...
    title = title + " *        allowed because a varchar can hold numeric characters. The    * ";
    ...
    title = title + " *        inconsistencies in the data. An example is to change a        * ";
